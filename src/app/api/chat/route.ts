...
const TOOLS = [
  {
    ...
    function: {
      ...
      description:
        "Проверить РЕАЛЬНУЮ доступность номеров и цены проживания на конкретные даты в системе бронирования (Exely). Вызывай всегда, когда гость спрашивает про свободные номера, цену проживания (Шале/Глэмпинг) или бронь на конкретную дату/период. Даты — в формате YYYY-MM-DD.",
      parameters: {
        type: "object",
        properties: {
