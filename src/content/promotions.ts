...
export const promotions: Promotion[] = [
  {
    ...
    terms: {
      ru: [
        ...
        "Питание «Всё включено»: завтрак, обед и ужин",
        "Гости сверх двоих — по тарифу за каждую ночь",
        "Тариф «Всё включено» отдельно оплачивать не нужно — питание уже входит",
      ],
      uz: [
        "Kirish dushanba ➔ chiqish payshanba (3 kecha)",
        "Kirish seshanba ➔ chiqish juma (3 kecha)",
        "2026-yil 30-sentabrgacha amal qiladi",
        "«Hammasi kiritilgan» ovqatlanish: nonushta, tushlik va kechki ovqat",
        "Ikki kishidan ortiq mehmonlar — har bir kecha uchun tarif bo'yicha",
        "«Hammasi kiritilgan» tarifini alohida to'lash shart emas — ovqatlanish kiritilgan",
      ],
      en: [
        ...
        "No need to pay for the All-Inclusive rate — meals are already included",
      ],
    },
  },
  {
    slug: "all-inclusive",
    // С витрины убрано 18.09.2026 по просьбе оператора: питание уже названо в
    // карточке «2+1», и вторая карточка про него же только повторяла условие.
    hiddenOnSite: true,
  ...
  {
    slug: "slow-weekend",
    // Тоже убрано с витрины 18.09.2026. Предложение действует, и администратор
    // подтверждает поздний выезд при брони — просто блок акций теперь про одно.
    hiddenOnSite: true,
