...
export const dayProducts: DayProduct[] = [
  {
    ...
    highlights: {
      ru: [
        ...
        `Работает ежедневно ${topchanPricing.hours}`,
      ...
      en: [
        ...
        `Open daily ${topchanPricing.hours}`,
  ...
  },
  {
    ...
    gallery: [
      /* Вечерние кадры идут первыми: подсветка — то, чего гость не ожидает
         от горки и чего нет ни у кого рядом. Дневные остаются ниже, они
         объясняют саму трассу. */
      "tubingDuskTrack",
      "tubingDuskRider",
      "tubingDuskFamily",
      "tubingDuskRun",
