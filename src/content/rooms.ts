...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    features: {
      ...
      ru: ["Включён в проживание в шале и глэмпинге", "Или бронь на день, гостей без лимита", "8 бунгало Standard до 4 человек и 4 бунгало Family до 10", "Работает ежедневно 08:00–20:00", "Место подтверждает администратор — без заявки свободное не гарантировано"],
      uz: ["Shale va glempingda yashashga kiritilgan", "Yoki bir kunlik bron, mehmonlar soni cheklanmagan", "4 kishilik 8 ta Standard va 10 kishilik 4 ta Family bungalo", "Har kuni 08:00–20:00", "Joyni administrator tasdiqlaydi — arizasiz bo'sh joy kafolatlanmaydi"],
      en: ["Included with chalet and glamping stays", "Or a day booking, any group size", "8 Standard bungalows for up to 4 and 4 Family ones for up to 10", "Open daily 08:00–20:00", "The administrator confirms your place — without a request a free one is not guaranteed"],
    },
