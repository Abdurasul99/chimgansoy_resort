...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    features: {
      ...
      ru: ["Включён в проживание в шале и глэмпинге", "Или бронь на день, гостей без лимита", "8 бунгало Standard до 4 человек и 4 бунгало Family до 10", `Работает ежедневно ${poolPricing.hours}`, "Место подтверждает администратор — без заявки свободное не гарантировано", "В купальнике — только у бассейна; по территории в одежде и обуви"],
      uz: ["Shale va glempingda yashashga kiritilgan", "Yoki bir kunlik bron, mehmonlar soni cheklanmagan", "4 kishilik 8 ta Standard va 10 kishilik 4 ta Family bungalo", `Har kuni ${poolPricing.hours}`, "Joyni administrator tasdiqlaydi — arizasiz bo'sh joy kafolatlanmaydi", "Cho'milish kiyimi — faqat basseyn yonida; hudud bo'ylab kiyim va oyoq kiyimda"],
      en: ["Included with chalet and glamping stays", "Or a day booking, any group size", "8 Standard bungalows for up to 4 and 4 Family ones for up to 10", `Open daily ${poolPricing.hours}`, "The administrator confirms your place — without a request a free one is not guaranteed", "Swimwear by the pool only; clothes and footwear elsewhere on site"],
    },
