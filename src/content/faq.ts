...
export function faqItems(live: LivePricing = resolvePricing()): FaqItem[] {
  ...
  },
  {
    ...
    answer: {
      ...
      uz: `Ha. Shale va glemping mehmonlari uchun basseyn narxga kiritilgan — alohida bron qilish shart emas. Yashashsiz — kunlik chipta: kattalar va 15 yoshdan katta bolalar ish kunlari (Du–Pay) ${P.poolAdultWeekday} so'm, dam olish kunlari (Ju–Yak) ${P.poolAdultWeekend} so'm; 5–15 yoshli bolalar — 50 000 va ${P.poolAdultWeekday} so'm; 5 yoshgacha kattalar bilan bepul. Sochiq ${P.towel} so'm, Standard bungalo 4 kishigacha — ${P.bungalow4} so'm (8 ta bor), Family bungalo 10 kishigacha — ${P.bungalow10} so'm (4 ta bor); kirish chiptalari bungalo ijarasiga kirmaydi. Basseyn har kuni 08:00–20:00, ariza — basseyn sahifasidagi shakl orqali.`,
      en: `Yes. For chalet and glamping guests the pool is included in the rate — no separate booking needed. Without a stay — a day pass: adults and ages 15+ pay ${P.poolAdultWeekday} UZS Mon–Thu and ${P.poolAdultWeekend} UZS Fri–Sun; children 5–15 pay 50 000 and 100 000; under-fives are free with an adult. Towel ${P.towel}, a Standard bungalow for up to 4 costs ${P.bungalow4} UZS (there are 8 of them), a Family bungalow for up to 10 costs ${P.bungalow10} UZS (there are 4); entry tickets are not included in a bungalow. The pool is open daily 08:00–20:00; requests go through the form on the pool page.`,
    },
  },
  {
    question: {
    ...
    answer: {
      ru: `Выберите даты и забронируйте онлайн на странице «Бронирование» или оставьте заявку — администратор подтвердит бронь в ближайшее время. После подтверждения в течение 24 часов вносится предоплата 100% стоимости (при брони менее чем за сутки — сразу). Предоплата невозвратная. Туристский сбор платят только иностранные граждане и лица без гражданства — ${P.taxForeign} сум за ночь с человека по ставке, действующей на дату заезда. Он не входит в стоимость и вносится при заселении; с граждан и резидентов Узбекистана не взимается. Можно также написать в WhatsApp или Telegram.`,
  ...
  },
  {
    ...
    answer: {
      ru: `Да, на день можно приехать тремя способами. Топчан — ${P.topchanWeekday} сум в будни (Пн–Чт) и 300 000 в выходные (Пт–Вс) за топчан целиком, до 8 гостей. Бассейн — 100 000 и ${P.poolAdultWeekend} сум с человека, дети 5–15 вдвое дешевле, до 5 лет бесплатно. Тюбинг-горка — ${P.ride2} сум за 2 спуска и 100 000 за 4, цена одна всю неделю. Вход на территорию бесплатный; парковка платная только для тюбинга — 50 000 и ${P.poolAdultWeekday} сум за автомобиль. У каждого формата своя форма заявки на сайте — администратор перезвонит и подтвердит. Заявку лучше оставить заранее: топчан и место у бассейна закрепляются только после подтверждения, и приехавшим без заявки свободное место не гарантировано.`,
      ...
      en: `Yes, in three ways. A topchan costs ${P.topchanWeekday} UZS Mon–Thu and 300 000 Fri–Sun for the whole platform, seating up to 8. The pool is 100 000 and ${P.poolAdultWeekend} UZS per person, half price for ages 5–15 and free under five. The tubing hill is ${P.ride2} UZS for 2 rides and 100 000 for 4, at one price all week. Entry to the grounds is free; parking is charged for tubing only, at 50 000 and ${P.poolAdultWeekday} UZS per car. Each has its own request form on the site, and the administrator calls back to confirm. Send it ahead: a topchan and a place at the pool are held only once confirmed, and arriving without a request does not guarantee a free one.`,
    },
  },
  ];
}
