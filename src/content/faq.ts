...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer: {
      ru: "Да, на день можно приехать тремя способами. Топчан — 150 000 сум в будни (Пн–Чт) и 300 000 в выходные (Пт–Вс) за топчан целиком, до 8 гостей. Бассейн — 100 000 и 200 000 сум с человека, дети 5–15 вдвое дешевле, до 5 лет бесплатно. Тюбинг-горка — 50 000 сум за 2 прокатки и 100 000 за 4, цена одна всю неделю. Въезд оплачивается отдельно: 50 000 и 100 000 сум за автомобиль. У каждого формата своя форма заявки на сайте — администратор перезвонит и подтвердит.",
      uz: "Ha, bir kunga uch xil kelish mumkin. Topchan — ish kunlari (Du–Pay) 150 000 so'm, dam olish kunlari (Ju–Yak) 300 000 so'm butun topchan uchun, 8 kishigacha. Basseyn — bir kishidan 100 000 va 200 000 so'm, 5–15 yosh ikki barobar arzon, 5 yoshgacha bepul. Tubing gorkasi — 2 marta uchish 50 000 so'm, 4 marta 100 000 so'm, narx butun hafta bir xil. Kirish alohida to'lanadi: avtomobil uchun 50 000 va 100 000 so'm. Har bir formatning saytda o'z arizasi bor — administrator qo'ng'iroq qilib tasdiqlaydi.",
      en: "Yes, in three ways. A topchan costs 150 000 UZS Mon–Thu and 300 000 Fri–Sun for the whole platform, seating up to 8. The pool is 100 000 and 200 000 UZS per person, half price for ages 5–15 and free under five. The tubing hill is 50 000 UZS for 2 rides and 100 000 for 4, at one price all week. Entry is charged separately at 50 000 and 100 000 UZS per car. Each has its own request form on the site, and the administrator calls back to confirm.",
    },
  },
];
