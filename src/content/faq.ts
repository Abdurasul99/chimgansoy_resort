...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer: {
      ru: "Дневной отдых с арендой топчана мы больше не проводим — комплекс работает как курорт с проживанием. Единственный вариант без ночёвки — бассейн на день: взрослые 100 000 сум в будни (Пн–Чт) и 200 000 в выходные (Пт–Вс), дети 5–15 — вдвое дешевле, до 5 лет бесплатно. Заявка оставляется формой на странице бассейна. Всё остальное на территории доступно гостям, которые останавливаются в шале или глэмпинге.",
      uz: "Topchan ijarasi bilan kunlik dam olishni biz endi o'tkazmaymiz — majmua yashash bilan kurort sifatida ishlaydi. Tunamasdan yagona variant — bir kunga basseyn: kattalar ish kunlari (Du–Pay) 100 000 so'm, dam olish kunlari (Ju–Yak) 200 000 so'm, 5–15 yosh ikki barobar arzon, 5 yoshgacha bepul. Ariza basseyn sahifasidagi shakl orqali. Hududdagi qolgan hamma narsa shale yoki glempingda to'xtagan mehmonlar uchun.",
      en: "We no longer run day visits with topchan rental — the property operates as a resort with overnight stays. The one option without staying over is the pool for a day: adults 100 000 UZS Mon–Thu and 200 000 Fri–Sun, ages 5–15 half price, under-fives free, requested through the form on the pool page. Everything else on the grounds is for guests staying in a chalet or a glamping cabin.",
    },
  },
];
