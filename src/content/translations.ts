...
export const dictionaries = {
  ru: {
    ...
    footer: {
      ...
      phone: "Телефон",
      message: "Ваш вопрос",
      messagePh: "О чём вы хотите спросить? Даты, услуга, что уточнить — пары строк достаточно",
      send: "Отправить заявку",
      sending: "Отправка...",
      success: "Заявка принята! Мы свяжемся с вами в ближайшее время.",
      errorRequired: "Заполните имя и телефон",
      errorMessage: "Напишите, о чём вопрос — иначе администратору придётся звонить и спрашивать заново",
  ...
  uz: {
    ...
    footer: {
      ...
      phone: "Telefon",
      message: "Savolingiz",
      messagePh: "Nimani so'ramoqchisiz? Sanalar, xizmat, aniqlashtirmoqchi bo'lgan narsa — bir-ikki qator yetarli",
      ...
      errorMessage: "Savolingizni yozing — aks holda administrator qo'ng'iroq qilib qaytadan so'rashiga to'g'ri keladi",
  ...
  en: {
    ...
    footer: {
      ...
      messagePh: "What would you like to ask? Dates, a service, something to clarify — a line or two is enough",
      send: "Send request",
      sending: "Sending...",
      success: "Request received! We will contact you shortly.",
      errorRequired: "Please fill in name and phone",
      errorMessage: "Tell us what your question is — otherwise the administrator has to call and ask all over again",
