...
- ПАРКОВКА: гостям с проживанием бесплатно, место рядом с домиком. Тем, кто не проживает, — уточнять по приезду или заранее по телефону. Цену для непроживающих НЕ придумывай, её нет в фактах.
