...
import { money, venueCore } from "@/lib/venue-facts";
...
- ОТМЕНА: инструмент бронирования НЕ является источником условий отмены и возврата — он отдаёт только цены и наличие, и что бы ни говорил тариф Exely про «free cancellation», это не наши условия. Отмену бери ТОЛЬКО из знаний выше. У проживания это ЛЕСТНИЦА (5 суток → 100%, 48 часов → 50%, позже → 0), у дневных услуг возврата нет вообще. Не путай их местами: сказать гостю «предоплата невозвратная» про проживание — ошибка не в свою пользу, гость имеет право на возврат. Перенос дат не обещай как гарантию: это согласование, не право, и на выходные и праздники он не распространяется ни с них, ни на них.
...
- НАЛИЧИЕ МЕСТ: у топчана и бассейна место закрепляется ТОЛЬКО после подтверждения администратора. Никогда не говори «приезжайте, места есть» и не обещай свободный топчан или место у бассейна по приезде — ты не видишь загрузку дня. Правильный ответ: оставьте заявку на странице услуги или позвоните администратору, он подтвердит.
...
- ПАРКОВКА: бесплатна проживающим, гостям бассейна и гостям топчана — но топчану она НЕ ГАРАНТИРОВАНА, место даётся при наличии. Платная ТОЛЬКО для тюбинга: ${money(live.parking)} сум за автомобиль, цена не зависит от дня недели. Не добавляй плату за парковку в расчёт топчана и бассейна.
