...
- ТЮБИНГ: цена за пакет прокаток, одинаковая всю неделю. Сезон зависит от снега и не объявлен — не обещай конкретных дат, скажи, что условия подтвердит администратор. Ссылку давай на форму заявки тюбинга.
