...
- ПАРКОВКА: бесплатна проживающим, гостям бассейна и гостям топчана — но топчану она НЕ ГАРАНТИРОВАНА, место даётся при наличии. Платная ТОЛЬКО для тюбинга: ${money(live.parking)} сум за автомобиль, одна цена всю неделю. Не добавляй плату за парковку в расчёт топчана и бассейна.
