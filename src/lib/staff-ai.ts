...
function systemPrompt(): string {
  return [
    ...
    "возрастам и дням — см. раздел БАССЕЙН), парковка и доп. услуги (мангал, казан, дрова, уголь).",
    "Пятница у бассейна — ВЫХОДНОЙ тариф. Дети 5–15 платят вдвое меньше, до 5 лет бесплатно.",
