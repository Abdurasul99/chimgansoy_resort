...
export async function setRateRange(
   ...
   *
   * Ради разных цен по дням это и сделано: с 24.09.2026 ночи Вс–Чт, пятница и
   * суббота стоят каждая по-своему, и задавать их по одному дню на месяц
   * вперёд — двенадцать заходов в форму вместо одного.
   */
  dows?: number[],
): Promise<number> {
